...
var _staticPropTypes = require("./static-prop-types");
...
function (_React$PureComponent) {
  ...
  _createClass(Provider, [{
    ...
    value: function render() {
      return _react["default"].createElement(_storeContext.StoreContext.Provider, {
...
Provider.propTypes = {
  store: _staticPropTypes.storeShape.isRequired
};